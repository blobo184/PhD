## Script to get model run times UK
...
sample_5 <- extract_times(paths = "C://Users/benlo/Dropbox (Royal Holloway)/Paper 3/Research/UK/Results/Sample_5/") %>%
  mutate(Sample = 5)
sample_10 <- extract_times(paths = "C://Users/benlo/Dropbox (Royal Holloway)/Paper 3/Research/UK/Results/Sample_10/") %>%
  mutate(Sample = 10)
sample_20 <- extract_times(paths = "C://Users/benlo/Dropbox (Royal Holloway)/Paper 3/Research/UK/Results/Sample_20/") %>%
  mutate(Sample = 20)
sample_30 <- extract_times(paths = "C://Users/benlo/Dropbox (Royal Holloway)/Paper 3/Research/UK/Results/Sample_30/") %>%
  mutate(Sample = 30)

## Combine frames and save
UK_model_times <- do.call("rbind", list(sample_5, sample_10, sample_20, sample_30)) 
save(UK_model_times, file = "../Results/UK_model_times.RData")
